...
@router.get("/{branch_id}/day/{week_day}", response_model=SettingsOut, status_code=status.HTTP_200_OK)
...
@router.patch("/{branch_id}/day/{week_day}", response_model=SettingsOut)
